...
export const metadata: Metadata = {
  ...
  description: "Explore the portfolio of Omar Ashour, a frontend and full-stack developer based in Edmonton, Alberta with expertise in modern web development technologies and a passion for crafting interactive, high-performance web applications.",
  keywords: [
